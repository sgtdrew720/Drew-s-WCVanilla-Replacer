...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef FlareAmmoStage1 => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "FlareClip", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Flare Long", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            Shape = new ShapeDef // Defines the collision shape of the projectile, defaults to LineShape and uses the visual Line Length if set to 0.
            {
                ...
                Diameter = 1f * 4f, // Diameter is minimum length of LineShape or minimum diameter of SphereShape.
            },
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Characters = 7f, // Character damage multiplier; defaults to 1 if zero or less.
        ...
        private AmmoDef FlareAmmoStage1Smart => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "FlareClip", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Flare Short", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 5f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
        ...
        private AmmoDef FlareAmmoStage2 => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 2f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
            Health = 0, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                RangeVariance = Random(start: 0, end: 0), // subtracts value from MaxTrajectory
                MaxTrajectoryTime = 0, // How long the weapon must fire before it reaches MaxTrajectory.
                DragPerSecond = 25f, // Amount of drag (m/s) deducted from the projectile's speed, multiplied by age.  Will not go below zero/negative.  Note that turrets will not be able to reliably account for this with non-smart ammo.
                Smarts = new SmartsDef
                {
                    Aggressiveness = 3f, // controls how responsive tracking is.
                    NavAcceleration = 0, // helps influence how the projectile steers, 0 defaults to 1/2 Aggressiveness value or 0 if its 0, a value less than 0 disables this feature.
