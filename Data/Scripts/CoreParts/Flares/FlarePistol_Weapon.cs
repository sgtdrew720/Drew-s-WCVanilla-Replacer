...
//using static Scripts.Structure.WeaponDefinition.TargetingDef.CommunicationDef;
...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition FlarePistol => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "FlareGunItem", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                Threats = new[] {
                    Characters, // Types of threat to engage: Grids, Projectiles, Characters, Meteors, Neutrals
                },
                SubSystems = new[] {
                    Thrust, Power, Offense, Any, // Subsystem targeting priority: Offense, Utility, Power, Production, Thrust, Jumping, Steering, Any
                },
            ...
            {
                PartName = "Flare Pistol", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    ReloadSound = "WepFlarePistolReload", // Sound SubtypeID, for when your Weapon is in a reloading state
