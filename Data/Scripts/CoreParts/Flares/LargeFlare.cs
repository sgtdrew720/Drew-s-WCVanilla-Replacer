...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition LargeFlare => new WeaponDefinition
        {
            ...
            {
                PartName = "Large Flare Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 16f, // Projectile inaccuracy in degrees.
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 0.024f, // Inventory capacity in kL.
