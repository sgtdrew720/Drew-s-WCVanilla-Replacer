    ...
    partial class Parts {
        ...
        WeaponDefinition LargeLaserTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                ...
                Muzzles = new[] {
                    "camera", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            Targeting = new TargetingDef
            {
                ...
                SubSystems = new[] {
                    Thrust, Power, Offense, Utility, Production, Any, // Subsystem targeting priority: Offense, Utility, Power, Production, Thrust, Jumping, Steering, Any
                },
                ...
                MaxTrackingTime = 30, // After this time has been reached the weapon will stop tracking existing target and scan for a new one
            ...
            HardPoint = new HardPointDef
            {
                ...
                DeviateShotAngle = 1.0f, // Projectile inaccuracy in degrees.
                AimingTolerance = 10f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                AimLeadingPrediction = Accurate, // Level of turret aim prediction; Off, Basic, Accurate, Advanced
                DelayCeaseFire = 6, // Measured in game ticks (6 = 100ms, 60 = 1 second, etc..). Length of time the weapon continues firing after trigger is released.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "ArcWepShipGatlingRotation", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "Muzzle_Flash_Laser", // SubtypeId of muzzle particle effect.
