...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef LargeRailgunSabot => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            EnergyCost = 0.60f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 79, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). time begins at 0 and time must EXCEED this value to trigger "time > maxValue". Please have a value for this, It stops Bad things.
        ...
        private AmmoDef SmallRailgunSabot => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 1.20f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
