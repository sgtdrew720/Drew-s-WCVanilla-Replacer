        ...
        WeaponDefinition SmallBlockRailgun => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 0.192f, // Inventory capacity in kL.
                ...
                Loading = new LoadingDef
                {
                    ...
                    DelayUntilFire = 37, // How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    ...
                    DelayAfterBurst = 37, // How long to spend "reloading" after each burst. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
