...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition LargeGatlingTurret => new WeaponDefinition
        {
            ...
            {
                Threats = new[] {
                    Characters, Projectiles, Grids, Meteors, // Types of threat to engage: Grids, Projectiles, Characters, Meteors, Neutrals
                },
                SubSystems = new[] {
            ...
            HardPoint = new HardPointDef
            {
                ...
                DeviateShotAngle = 0.9f, // Projectile inaccuracy in degrees.
                ...
                {
                    RotateRate = 0.0785f, // Max traversal speed of azimuth subpart in radians per tick (0.1 is approximately 360 degrees per second).
                    ElevateRate = 0.0785f, // Max traversal speed of elevation subpart in radians per tick.
                    MinAzimuth = -180,
                    MaxAzimuth = 180,
                    MinElevation = -40,
                    MaxElevation = 90,
        ...
        WeaponDefinition SmallGatlingTurret => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                DeviateShotAngle = 0.8f, // Projectile inaccuracy in degrees.
                AimingTolerance = 45f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                AimLeadingPrediction = Accurate, // Level of turret aim prediction; Off, Basic, Accurate, Advanced
                DelayCeaseFire = 10, // Measured in game ticks (6 = 100ms, 60 = 1 second, etc..). Length of time the weapon continues firing after trigger is released.
                AddToleranceToTracking = false, // Allows turret to track to the edge of the AimingTolerance cone instead of dead centre.
                ...
                HardWare = new HardwareDef
                {
                    ...
                    HomeAzimuth = 0, // Default resting rotation angle
                    HomeElevation = 0, // Default resting elevation
                    InventorySize = 0.15f, // Inventory capacity in kL.
                    IdlePower = 0.2f, // Constant base power draw in MW.
                    FixedOffset = false, // Deprecated.
                    Offset = Vector(x: 0, y: 0, z: 0), // Offsets the aiming/firing line of the weapon, in metres.
                    Type = BlockWeapon, // What type of weapon this is; BlockWeapon, HandWeapon, Phantom 
