    ...
    partial class Parts {
        ...
        WeaponDefinition LargeBlockAssaultCannonTurret => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                DeviateShotAngle = 0.132f, // Projectile inaccuracy in degrees.
                ...
                {
                    RotateRate = 0.0262f, // Max traversal speed of azimuth subpart in radians per tick (0.1 is approximately 360 degrees per second).
                    ElevateRate = 0.0262f, // Max traversal speed of elevation subpart in radians per tick.
                    MinAzimuth = -180,
                    MaxAzimuth = 180,
                    MinElevation = -20,
                    MaxElevation = 75,
                    ...
                    InventorySize = 0.54f, // Inventory capacity in kL.
                    IdlePower = 0.4f, // Constant base power draw in MW.
        ...
        WeaponDefinition SmallBlockAssaultCannon => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                DeviateShotAngle = 0.108f, // Projectile inaccuracy in degrees.
                AimingTolerance = 2f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                AimLeadingPrediction = Advanced, // Level of turret aim prediction; Off, Basic, Accurate, Advanced
                DelayCeaseFire = 0, // Measured in game ticks (6 = 100ms, 60 = 1 second, etc..). Length of time the weapon continues firing after trigger is released.
                AddToleranceToTracking = false, // Allows turret to track to the edge of the AimingTolerance cone instead of dead centre.
                ...
                HardWare = new HardwareDef
                {
                    ...
                    HomeAzimuth = 0, // Default resting rotation angle
                    HomeElevation = 0, // Default resting elevation
                    InventorySize = 0.27f, // Inventory capacity in kL.
        ...
        WeaponDefinition SmallBlockAssaultCannonTurret => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                DeviateShotAngle = 0.152f, // Projectile inaccuracy in degrees.
                AimingTolerance = 2f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                AimLeadingPrediction = Advanced, // Level of turret aim prediction; Off, Basic, Accurate, Advanced
                DelayCeaseFire = 0, // Measured in game ticks (6 = 100ms, 60 = 1 second, etc..). Length of time the weapon continues firing after trigger is released.
                AddToleranceToTracking = false, // Allows turret to track to the edge of the AimingTolerance cone instead of dead centre.
