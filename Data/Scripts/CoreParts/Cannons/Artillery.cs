        ...
        WeaponDefinition LargeBlockArtillery => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 0.9f, // Inventory capacity in kL.
            ...
            Ammos = new[] {
               APHEArtilleryShell,
               HEArtilleryShell, // Must list all primary, shrapnel, and pattern ammos.
            },
        ...
        WeaponDefinition LargeBlockArtilleryTurret => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                HardWare = new HardwareDef
                {
                    ...
                    HomeAzimuth = 0, // Default resting rotation angle
                    HomeElevation = 0, // Default resting elevation
                    InventorySize = 1.8f, // Inventory capacity in kL.
            ...
            Ammos = new[] {
                APHEArtilleryShell,
                HEArtilleryShell, // Must list all primary, shrapnel, and pattern ammos. // Must list all primary, shrapnel, and pattern ammos.
            },
            //Animations = Weapon75_Animation,
            //Upgrades = UpgradeModules,
        };
