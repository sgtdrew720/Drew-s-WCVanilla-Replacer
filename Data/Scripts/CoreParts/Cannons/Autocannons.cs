    ...
    partial class Parts {
        ...
        WeaponDefinition SmallBlockAutocannon => new WeaponDefinition
        {
            ...
            Targeting = new TargetingDef
            {
                ...
                MaxTrackingTime = 90, // After this time has been reached the weapon will stop tracking existing target and scan for a new one
        ...
        WeaponDefinition AutoCannonTurret => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                HardWare = new HardwareDef
                {
                    RotateRate = 0.0524f, // Max traversal speed of azimuth subpart in radians per tick (0.1 is approximately 360 degrees per second).
                    ElevateRate = 0.0524f, // Max traversal speed of elevation subpart in radians per tick.
                    MinAzimuth = -180,
                    MaxAzimuth = 180,
                    MinElevation = -10,
                    MaxElevation = 90,
