...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition SGMissileLauncher => new WeaponDefinition()
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "SGMissileLauncher", // Block Subtypeid. Your Cubeblocks contain this information
                    ...
                    new MountPointDef {
                        SubtypeId = "SGMissileLauncherWarfare2", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "None", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "None", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "None",// Your Elevating Subpart, that bit that moves up.
            ...
            HardPoint = new HardPointDef
            {
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 0.080f, // Inventory capacity in kL.
                ...
                Loading = new LoadingDef
                {
                    ...
                    Cooldown = .9f, // Percentage of max heat to be under to start firing again after overheat; accepts 0 - 0.95
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    BarrelRotationSound = "WepTurretGatlingRotate",
